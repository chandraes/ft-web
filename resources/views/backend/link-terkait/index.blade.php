        ...
        <div class="card ">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="{{route('link-terkait.create')}}" class="btn btn-primary">{{__('Add New')}}</a>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a class="btn btn-primary btn-sm rounded-11 mx-2 btn-block"
                                                data-bs-toggle="tooltip" href="{{route('link-terkait.edit', $d->id)}}"
                                        ...
                                        <div class="col-6">
                                            <form id="delete-item" action="{{route('link-terkait.destroy', $d->id)}}"
                                                method="post">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit"
