    ...
    <div class="col-12 col-sm-12">
        <div class="card ">
            <div class="card-header">
                <h3 class="card-title mb-0">{{__('List Carousel')}}</h3>
                <div class="card-options">
                    <a href="{{route('carousel.create')}}" class="btn btn-primary">{{__('Add New')}}</a>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <td class="align-middle text-center">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            href="{{route('carousel.edit', $d->id)}}" data-bs-original-title="Edit"><i><svg
                                            ...
                                            <div class="col-6">
                                                <form  id="delete-item" action="{{route('carousel.destroy', $d->id)}}" method="post">
                                                    @method('DELETE')
                                                    @csrf
