        ...
        <div class="card ">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="{{route('pimpinan.create')}}" class="btn btn-primary">{{__('Add New')}}</a>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <td align="center">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            href="{{route('pimpinan.edit', $d->id)}}" data-bs-original-title="Edit"><i><svg
                                            ...
                                            <div class="col-6">
                                                <form  id="delete-item" action="{{route('pimpinan.destroy', $d->id)}}" method="post">
                                                    @method('DELETE')
                                                    @csrf
