        ...
        <div class="card ">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a class="modal-effect btn btn-success d-grid mx-3" data-bs-effect="effect-slide-in-right" data-bs-toggle="modal" href="#jurusan">Slide In Right</a>
                                ...
                                <td align="center">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            href="{{route('dosen.edit', $d->id)}}" data-bs-original-title="Edit"><i><svg
                                            ...
                                            <div class="col-6">
                                                <form  id="delete-item" action="{{route('dosen.destroy', $d->id)}}" method="post">
                                                    @method('DELETE')
                                                    @csrf
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">List Jurusan / Prodi</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" ><span aria-hidden="true">&times;</span></button>
            </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" >Save</button> <button class="btn btn-light" data-bs-dismiss="modal" >Close</button>
            </div>
            </form>
        </div>
    </div>
