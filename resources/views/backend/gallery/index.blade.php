    ...
    <div class="col-12 col-sm-12">
        <div class="card ">
            <div class="card-header">
                <h3 class="card-title mb-0">{{__('List Gallery')}}</h3>
                <div class="card-options">
                    <a href="{{route('galeri.create')}}" class="btn btn-primary">{{__('Add New')}}</a>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <td class="align-middle text-center">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            href="{{route('galeri.edit', $d->id)}}" data-bs-original-title="Edit"><i><svg
                                            ...
                                            <div class="col-6">
                                                <form  id="delete-item" action="{{route('galeri.destroy', $d->id)}}" method="post">
                                                    @method('DELETE')
                                                    @csrf
